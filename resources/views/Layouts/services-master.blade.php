...
<head>
    ...
    <title>OBLONG-Hizmetlerimiz </title>
    <meta name="description" content="">
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <link rel="manifest" href="site.webmanifest">
    <link rel="shortcut icon" type="image/x-icon" href="assets/img/analogo1.png">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="section-tittle text-center mb-100">
                        <span>En İyi Hizmetlerimiz</span>
                        <h2>Dijital dünyada Oblong</h2>
                    </div>
                </div>
            </div>
            <div class="row">
                    ...
                    <div class="services-wrapper mb-50">
                        <div class="single-services">
                            ...
                            <div class="services-cap">
                                ...
                                <p>Güvenli şekilde sistemden elde ettiğimiz verilerinizle periyodik olarak müşterileriniz, satışlarınız, tedarikçileriniz hakkında size rapor sunalım</p>
                                <a href="/services" class="get-btn"><i class="ti-arrow-right"></i>İnceleyin</a>
                            </div>
                        </div>
                ...
                <div class="col-lg-4 col-md-6 col-sm-6">
                    <div class="services-wrapper mb-50">
                        <div class="single-services">
                            ...
                            <div class="services-cap">
                                <h3><a href="services.html">E-İhale</a></h3>
                                <p>Alıcı ve satıcıları bir araya getirdiğimiz bu oblongmark.com platformunda online ihalelerle düzenli ve kaliteli alışveriş yapın.</p>
                                <a href="services.html" class="get-btn"><i class="ti-arrow-right"></i>İnceleyin</a>
                            </div>
                        </div>
                        <div class="services-shape">
                            <img src="assets/img/gallery/shape-services.png" alt="">
                ...
                <div class="col-lg-4 col-md-6 col-sm-6">
                    <div class="services-wrapper mb-50">
                        <div class="single-services">
                            ...
                            <div class="services-cap">
                                <h3><a href="services.html">Pazarlama Yönetimi</a></h3>
                                <p>Şirketiniz dijital sektörde yeni ise markalaşma ve pazarlama süreçlerinizin tamamında yanınızda olalım. Reklam süreçlerinizi ve online satışlarınızı birlikte planlayalım.</p>
                                <a href="services.html" class="get-btn"><i class="ti-arrow-right"></i>İnceleyin</a>
                            </div>
                        </div>
                        <div class="services-shape">
                    ...
                    <div class="services-wrapper mb-50">
                        <div class="single-services">
                            ...
                            <div class="services-cap">
                                ...
                                <p>Güvenli bir şekilde müşteri sistemde alışveriş yaptığınız tedarikçi ve müşteri verilerinizi depolayabilirsiniz.</p>
                                <a href="services.html" class="get-btn"><i class="ti-arrow-right"></i>İnceleyin</a>
                            </div>
                        </div>
                        <div class="services-shape">
                ...
                <div class="col-lg-4 col-md-6 col-sm-6">
                    <div class="services-wrapper mb-50">
                        <div class="single-services">
                            ...
                            <div class="services-cap">
                                <h3><a href="services.html">CRM</a></h3>
                                <p>Satınalma ve pazarlama departmanlarında için kullanılan CRM altyapısı ile düzenli rapor akışı sağlayabilir süreçlerinizi yönetebilirsiniz.</p>
                                <a href="services.html" class="get-btn"><i class="ti-arrow-right"></i>İnceleyin</a>
                            </div>
                        </div>
                        <div class="services-shape">
                ...
                <div class="col-lg-4 col-md-6 col-sm-6">
                    <div class="services-wrapper mb-50">
                        <div class="single-services">
                            ...
                            <div class="services-cap">
                                <h3><a href="services.html">E-ticaret ve Dünya Pazarı</a></h3>
                                <p>Ürünleriniz yurt dışına satmak istiyorsanız E-ticaret sistemimiz ile doğru müşterilerle dil desteği ile iletişim kurun. </p>
                                <a href="services.html" class="get-btn"><i class="ti-arrow-right"></i>İnceleyin</a>
                            </div>
                        </div>
                        <div class="services-shape">
                        ...
                        <div class="single-footer-caption mb-50">
                            <div class="single-footer-caption mb-30">
                                ...
                                <div class="footer-logo">
                                    <a href="/qwe"><img src="assets/img/logo/analogo1.png" width="200" alt=""></a>
                                </div>
                            </div>
                        </div>
                    </div>
