...
<header>
    <!-- Header Start -->
    <div class="header-area header-transparent" style="background-color: #0f192a">
...
<div class="content">
        ...
        <div class="container" >
            <div class="row">
                <div class="col-md-9 m-auto">
                   <center>  <h1 class="pt-80 mb-40">
                        Güçlü Alıcılar ve Uzman Tedarikçiler<br>
                        <b>Dijital B2B Satın Alma Platformu</b><br>
                        Oblong ile Bir Araya Geliyor!
                       </h1> </center>
                </div>
            </div>
        </div>
            <div class="row">
                <div class="col-md-5 m-auto">
                    <a style="color:white" href="/uyelik/#video" id="anc"><i><strong>"Silver Üye"</strong> Avantajlarını Görmek İçin Tıklayın...</i></a>
                </div>
            </div>
        </div>
        <div class="container-fluid w-85 mt-5">
            <div class="row">
                <div class="col-lg-12 col-xl-6" >
                    <div class="container" >
                        <div class="row" style="background-color: lightblue">
                            <div class="col-md-12 uyelik-box">
                                <h4 class="title"><span>Bronz</span> Üyelik</h4>
                                <ul>
                                    <li><img src="images/checked.png" alt="Dahil" width="25"> Kategori Bazlı Bildirimler</li>
                                    <li><img src="images/checked.png" alt="Dahil" width="25"> Genele Açılan İhaleleri Görüntüleme</li>
                                    <li><img src="images/cancel.png" alt="Dahil" width="25"> Tüm Alıcı Firmaların İhalelerine Davet Olanağı</li>
                                    <li><img src="images/cancel.png" alt="Dahil" width="25"> Rehberde Görünür Olma</li>
                                    <li><img src="images/checked.png" alt="Dahil" width="25"> Genele Açılan İhalelere Teklif Verebilme</li>
                                    <li><img src="images/checked.png" alt="Dahil" width="25"> İleri Veri Analitiği ile Önerilen İhalelere Teklif Verebilme</li>
                                </ul>
                                <div class="container">
                                    <div class="row">
                                        <div class="col-xs-12 col-sm-6 col-xl-12 label-box" data-year="1">
                                            <label class="w-100">
                                                <input type="radio" name="forSilver"><span class="checkmark"></span> 1 Yıllık Üyelik <span class="price"><span>1.090</span>,00 TL<span class="tax">(KDV Dâhil)</span></span>
                                            </label>
                                        </div>
                                        <div class="col-xs-12 col-sm-6 col-xl-12 label-box active" data-year="2">
                                            <label class="w-100">
                                                <input type="radio" name="forSilver" checked=""><span class="checkmark"></span> 2 Yıllık Üyelik <span class="price"><span>2.050</span>,00 TL<span class="tax">(KDV Dâhil)</span></span>
                                            </label>

                                        </div>
                                    </div>
                                </div>
                                <a href="/register" class="genric-btn primary radius">Hemen Üye Ol</a>
                                <br><br>
                            </div>
                        </div>
                    </div>
                ...
                <br><br><br>
                 <div class="col-lg-12 col-xl-6 mt-5 mt-xl-0 mb-5 mb-xl-0">
                    <div class="container" style="radius: 5px">
                        <div class="row" style="background-color: #8f9195">
                            <div class="col-md-12 uyelik-box orange">

                                <h4 class="title"><span>Silver</span> Üyelik</h4>
                ...
                <div class="col-lg-12 col-xl-6 mt-5 mt-xl-0 mb-5 mb-xl-0" style="margin-left: 290px">
                    <div class="container" style="margin-top: 20px">
                        <div class="row" style="background-color: goldenrod">
                            <div class="col-md-12 uyelik-box orange">

                                <h4 class="title"><span>Gold</span> Üyelik</h4>

                                <ul>
                                    <li><img src="images/checked.png" alt="Dahil" width="25"> Kategori Bazlı Bildirimler</li>
                                    <li><img src="images/checked.png" alt="Dahil" width="25"> Genele Açılan İhaleleri Görüntüleme</li>
                                    <li><img src="images/checked.png" alt="Dahil" width="25"> Tüm Alıcı Firmaların İhalelerine Davet Olanağı</li>
                                    <li><img src="images/checked.png" alt="Dahil" width="25"> Rehberde Görünür Olma</li>
                                    <li><img src="images/checked.png" alt="Dahil" width="25"> Genele Açılan İhalelere Teklif Verebilme</li>
                                    <li><img src="images/checked.png" alt="Dahil" width="25"> İleri Veri Analitiği ile Önerilen İhalelere Teklif Verebilme</li>
                                </ul>
                                <div class="container">
    ...
    <div class="uyelik-body pt-80">
        <center>
            <h4 class="pt-80 mb-80"><span>Oblong Dünyası'nın Özellikleri</span></h4>
        </center>

        <div class="container uyelik-icons-wrapper mb-80">
            <div class="row">
                <div class="col-6 col-md-6 col-lg-3 col-xl-3">
                    <div class="icon-container">
                        <span class="pratis pratis-acik-ihale"></span>
                        <span>Açık İhaleler</span>
                    </div>
                </div>
                <div class="col-6 col-md-6 col-lg-3 col-xl-3">
                    <div class="icon-container">
                        <span class="pratis pratis-yeni-musteriler-firsatlar"></span>
                        <span>
                            Yeni Müşteriler<br>Yeni Fırsatlar
                        </span>
                    </div>
                </div>
                <div class="col-6 col-md-6 col-lg-3 col-xl-3">
                    <div class="icon-container">
                        <span class="pratis pratis-firma-tanitim-imkani"></span>
                        <span>
                            Firma Tanıtım
                            İmkânı
                        </span>
                ...
                <div class="col-6 col-md-6 col-lg-3 col-xl-3">
                    <div class="icon-container">
                        <span class="pratis pratis-ihale-bildirimleri"></span>
                        <span>
                            Veri Analizi<br>
                        </span>
                    </div>
            ...
            <div class="row">
                <div class="col-6 col-md-6 col-lg-3 col-xl-3">
                    <div class="icon-container">
                        <span class="pratis pratis-seffaf-iletisim"></span>
                        <span>
                           Müşteri optimizasyonu<br>
                ...
                <div class="col-6 col-md-6 col-lg-3 col-xl-3">
                    <div class="icon-container">
                        <span class="pratis pratis-musteri-memnuniyeti"></span>
                        <span>
                            Verimli Satış
                            Süreci ile Müşteri
                            Memnuniyeti
                ...
                <div class="col-6 col-md-6 col-lg-3 col-xl-3">
                    <div class="icon-container">
                        <span class="pratis pratis-kontrol-edilebilirlik"></span>
                        <span>
                            Kontrol
                            Edilebilirlik
                        </span>
                ...
                <div class="col-6 col-md-6 col-lg-3 col-xl-3">
                    <div class="icon-container">
                        <span class="pratis pratis-hata-minimizasyonu"></span>
                        <span>
                            İş Yükü ve <br>Hata
                            Minimizasyonu
                        </span>
            ...
            <div class="row">
                ...
                <div class="col-6 col-md-6 col-lg-3 col-xl-3">
                    <div class="icon-container">
                        <span class="pratis pratis-mail-sms-bildirimleri"></span>
                        <span>
                            Mail ve SMS ile<br>
                            Düzenli
                            Bildirimler
                ...
                <div class="col-6 col-md-6 col-lg-3 col-xl-3">
                    <div class="icon-container">
                        <span class="pratis pratis-guclu-alici-iliskileri"></span>
                        <span>
                            E-ticaret Sistem Yönetimi
                        </span>
                    </div>
                </div>
                <div class="col-6 col-md-6 col-lg-3 col-xl-3">
                    <div class="icon-container">
                        <span class="pratis pratis-antlasmalar"></span>
                        <span>
                            Oblong<br>
                            bünyesinde
                            tasarım desteği
