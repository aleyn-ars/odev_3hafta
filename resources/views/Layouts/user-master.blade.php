...
<head>
    ...
    <link rel="shortcut icon" type="image/x-icon" href="/images/analogo.png">
                ...
                <div class="container-fluid">
                    <div class="row align-items-center">
                        ...
                        <div class="col-xl-2 col-lg-1 col-md-1">
                            <div class="logo">
                                <a href="/qwe"><img src="assets/img/logo/analogo1.png" alt="" style="" width="200"></a>
                            </div>
                        </div>
                        <div class="col-xl-8 col-lg-8 col-md-8">
                            ...
                            <div class="main-menu f-right d-none d-lg-block">
                                <nav>
                                    <ul id="navigation">
                                        <li><a href="/qwe">Anasayfa</a></li>
                                        <li><a href="/about">Hakkımızda</a>
                                            <ul class="submenu">
                                                <li><a href="/reference">Müşteri Referanslarımız</a></li>
                                            </ul></li>
                                        <li><a href="/services">Hizmetlerimiz</a>
                                            <ul class="submenu">
                                                <li><a href="/blogPage">İleri veri Analitiği</a></li>
                                                <li><a href="blog_details.html">Dijital Pazarlama Danışmanlığı</a></li>
                                                <li><a href="blog_details.html">Reklam Yönetimi</a></li>

                                            </ul>
                                        </li>
                                        <li><a href="/blogPage">Blog</a>
                                        </li>

                                        <li><a href="#">Alıcılar</a>
                                            <ul class="submenu">
                                                <li><a href="elements.html">Satınalma ve e-ihale</a></li>
                                                <li><a href="elements.html">Dijital B2B Satınalma Platformu</a></li>
                                                <li><a href="elements.html">Tedarikçi Yönetimi ve Değerlendirme</a></li>
                                                <li><a href="elements.html">Teknik Değerlendirme</a></li>
                                            </ul>
                                        </li>
                                        <li><a href="#">Tedarikçiler</a>
                                            <ul class="submenu">
                                                <li><a href="elements.html">E-ihale bildirimleri</a></li>
                                                <li><a href="elements.html">Dijital B2B Satınalma Platformu</a></li>
                                                <li><a href="elements.html">Müşteri Analizi</a></li>
                                                <li><a href="elements.html">Katılım ve Satış Süreci</a></li>
                                                <li><a href="elements.html">Reklam Yönetimi</a></li>
                                            </ul>
                                        </li>
                    ...
                    <div class="row align-items-center">
                        <div class="col-lg-6 col-md-9 ">
                            <div class="hero__caption">
                                <h1 data-animation="fadeInLeft" data-delay=".3s">Dijital Pazarlama ve reklamcılık çözümleri! </h1>
                                <p data-animation="fadeInLeft" data-delay=".6s">Oblong dijital pazarlama hizmetlerimiz sayesinde doğru müşteri ve tedarikçilere bizimle ulaşın!
                                    İhtiyacınıza göre oluşturduğumuz farklı pazarlama paketleri şirketinizi online pazarlamada üstte taşıyacak</p>
                                <!-- Slider btn -->
                                <div class="slider-btns">
                                    <!-- Hero-btn -->
                                    <a data-animation="fadeInLeft" data-delay="1s" href="/purchase" class="btn radius-btn">Hemen Katılın</a>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-6">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="section-tittle text-center mb-100">
                        <span>EN İYİ HİZMETLERİMİZ</span>
                    ...
                    <div class="services-wrapper mb-50">
                        <div class="single-services">
                            ...
                            <div class="services-cap">
                                <h3><a href="services.html">İleri Veri Analizi</a></h3>
                                <p>Fiyat araştırmasından potansiyel müşteri analizine kadar tüm satınalma ve teadrik süreçlerinde ileri
                                veri analizi ile süreçlerinizi optimize ediyoruz.Kullanıcı panelinizde şirketize ait verileri güvenli şekilde tutabilir
                                böylece para akışınızı kolayca takip edebilirsiniz</p>
                                <a href="services.html" class="get-btn"><i class="ti-arrow-right"></i> Hemen Katılın</a>
                            </div>
                        </div>
                ...
                <div class="col-lg-4 col-md-6 col-sm-6">
                    <div class="services-wrapper mb-50">
                        <div class="single-services">
                            ...
                            <div class="services-cap">
                                <h3><a href="services.html">Veri Depolama</a></h3>
                                <p>Cloud teknolojisini kullanarak verilerinizi sistemde güvenilir şekilde saklayabilirsiniz</p>
                                <a href="services.html" class="get-btn"><i class="ti-arrow-right"></i> Hemen Katılın</a>
                            </div>
                        </div>
                        <div class="services-shape">
                ...
                <div class="col-lg-4 col-md-6 col-sm-6">
                    <div class="services-wrapper mb-50">
                        <div class="single-services">
                            ...
                            <div class="services-cap">
                                <h3><a href="services.html">E-ihale</a></h3>
                                <p>Tedarikçilerle alıcıları bir araya getiren onlong e-ihale platformu güvenilir ticaretin merkezidir.
                                Müşteri ilişkilerinizi takip edebilir puanlama sistemi ile belirlediğimiz en iyi
                                tedarikçi firmalardan alışveriş yapabilirsiniz.</p>
                                <a href="services.html" class="get-btn"><i class="ti-arrow-right"></i> Hemen Katılın</a>
                            </div>
                        </div>
                        <div class="services-shape">
            ...
            <div class="row align-items-end mb-80">
                <div class="col-xl-4">
                    ...
                    <div class="section-tittle section-tittle2">
                        ...
                        <h2>Hizmetlerimiz hakkında daha fazla bilgi edinmek için arayınız</h2>
                    </div>
                </div>
                <div class="col-xl-8">
                    <!-- Search Box -->
                    <form action="#" class="search-box">
                        <div class="input-form">
                            <input type="text" placeholder="Dijital hizmet ara">
                        </div>
            ...
            <div class="row">
                <div class="domain-list">
                    <div class="single-domain">
                        <span>İleri Veri Analizi</span>
                    </div>
                    <div class="single-domain">
                        <span>E-İhale</span>
                    </div>
                    <div class="single-domain">
                        <span>Online Reklam Yönetimi</span>
                    </div>
                    <div class="single-domain">
                        <span>Veri Depolama</span>
                    </div>
                    <div class="single-domain">
                        <span>Dijital Pazarlama Danışmanlığı</span>
                    </div>
                </div>
            </div>
            <!-- Domain List  End-->
        ...
        <div class="starups">
            <div class="starups-details">
                ...
                <div class="section-tittle section-tittle3">
                    ...
                    <h2>Dijital dünyada sizinde parmak iziniz olsun</h2>
                </div>
                <!-- details caption -->
                <div class="details-caption">
                    <p>Oblong digital pazarlama ve reklamcılık şirketi olarak oblongall.com ve oblongmark.com olmak üzere iki farklı sitede müşterilerimize
                    hizmet vermekteyiz oblongmark.com şirketlere daha interaktif kullanabileceği bir sistem sunar oblongall.com ise reklam ve tasarım ağırrlıklı olarak şirketlerin
                    piyasa ilk günden yanında olduğumuz hizmetleri sunar.</p>
                    <p>Amacımız dünyadaki dijital devrimde sizlerle birlikte yürümektir.</p>
                </div>
                <a href="#" class="btn">Hemen Katılın</a>
            </div>
        </div>
        <!--Right Contents  -->
            ...
            <div class="row align-items-center">
                            ...
                            <div class="testimonial-caption ">
                                ...
                                <div class="testimonial-founder d-flex align-items-center mb-30">
                                    <div class="founder-img">
                                        <img src="assets/img/testmonial/foto.jpg" alt="">
                                    </div>
                                    <div class="founder-text">
                                        <span>Aleyna Arslan</span>
                                        <p>Founder,Oblong Digital Marketing </p>
                                    </div>
                                </div>
                                <div class="testimonial-top-cap">
                                    <p>Oblong Dijital Pazarlama ve Reklamcılık ailesi olarak online pazarlama sektöründe birçok firmaya danışmanlık vermekteyiz. Şirketlerin günümüz satış stratejilerinde rekabet edebilmeleri için ekip olarak ,Bursa ekibi başta olmak üzere Türkiye ve yurt dışında farklı sektörlerle ortak çalışmaktan keyif alıyoruz. Sizinle birlikte bizde gelişiyoruz.</p>
                                </div>
                            </div>
                        </div>
                        <!-- Single Testimonial -->
                ...
                <div class="col-lg-5 col-md-5">
                    <div class="testimonial-banner">
                        <img src="assets/img/gallery/together.jpg" alt="">
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="col-lg-5">
                    <div class="support-caption">
                        ...
                        <div class="section-tittle section-tittle5">
                            ...
                            <p class="support-details">Canlı destek hizmetimizde 7/24 bize ulaşabilir hizmetlerimiz hakkında bilgi alabilirsiniz</p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-6">
            ...
            <div class="row">
                <div class="col-lg-4 col-md-6">
                    <div class="single-blogs mb-100">
                        ...
                        <div class="blog-cap">
                            <span class="color1">23 Haziran 2020</span>
                            <h4><a href="#"></a>E-ihalenin avantajları</h4>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6">
                    <div class="single-blogs mb-100">
                        ...
                        <div class="blog-cap">
                            <span class="color1">5 Temmuz 2020</span>
                            <h4><a href="#">Google reklamlarını Türkiye'den kaldıracak mı?</a></h4>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6">
                    <div class="single-blogs mb-100">
                        ...
                        <div class="blog-cap">
                            <span class="color1">13 Eylül 2020</span>
                            <h4><a href="#">Dijital pazarlama yeni trendler</a></h4>
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        <div class="single-footer-caption mb-50">
                            <div class="single-footer-caption mb-30">
                                ...
                                <div class="footer-logo">
                                    <a href="index.html"><img src="assets/img/logo/analogo1.png" width="200" alt=""></a>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-2 col-lg-2 col-md-4 col-sm-6">
                        <div class="single-footer-caption mb-50">
                            <div class="footer-tittle">
                                <h4>Dijital Paketlerimiz</h4>
                                <ul>
                                    <li><a href="/purchase">Bronz</a></li>
                                    <li><a href="/purchase">Silver</a></li>
                    ...
                    <div class="col-xl-3 col-lg-3 col-md-4 col-sm-6">
                        <div class="single-footer-caption mb-50">
                            <div class="footer-tittle">
                                <h4>+1 514 648 256</h4>
                                <ul>
                                    <li><a href="#">info@oblongall.com</a></li>
                                </ul>
                                <p>Oblong ofis adresi</p>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-xl-9 col-lg-9 ">
                        <div class="footer-copy-right">
                            <p><!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
                                Oblong &copy;<script>document.write(new Date().getFullYear());</script> Tüm hakları saklıdır. <i class="fa fa-heart" aria-hidden="true"></i><a href="https://colorlib.com" target="_blank">Oblong</a>
