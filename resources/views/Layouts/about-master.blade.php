        ...
        <div class="starups">
            <div class="starups-details">
                ...
                <div class="section-tittle section-tittle3">
                    <span>OBLONGMARK.COM</span>
                    <h2>Dijital Dünyada Sizinde Parmak İziniz Olsun!</h2>
                </div>
                <!-- details caption -->
                <div class="details-caption">
                    <p>Oblong dijital pazarlama ve reklamcılık bünyesindeki profesyonel ve entelektüel ekibimizin özverili katkılarıyla, kurumsal ve kurumsal olmayan iş süreçlerine uygun çözümler üreten yenilikçi ve rekabetçi bir kurum kimliğine sahibiz. Hızla değişen ve baş döndürücü bir şekilde gelişen bilişim sektöründe ki yenilikleri takip eden, dinamizmi yakalamış ekibimiz, rekabetçi piyasa koşullarında sizleri hedef kitleniz ile günün her saatinde buluşturmanın gururunu yaşamaktadır.</p>
                    <p>Tasarım ve yazılım birleştiği günümüz dijital dünyasında göze hitap eden ergonomik pazarlama sistemleriyle sektörde yerinizi almanız için yanınızdayız.</p>
                </div>
                <a href="http://oblongall.com/" class="btn">oblongall.com</a>
            </div>
        </div>
        <!--Right Contents  -->
        <div class="starups-img">
            <img src="assets/img/gallery/bck.jpg" alt="">
        </div>
    </section>
